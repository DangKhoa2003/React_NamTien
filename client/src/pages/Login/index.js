        ...
        <div className={cx('wrapper', 'container', 'mgin-5')}>
            <form className={cx('form_container')} onSubmit={handleSubmit}>
                ...
                <div className={cx('input_container')}>
                    <label className={cx('input_label')} htmlFor="email_field">
                        Email
                    </label>
                    <svg
                        fill="none"
                ...
                <button title="Sign In" type="submit" className={cx('sign-in_ggl')}>
